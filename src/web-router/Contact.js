        ...
        <div>
            <div id="contact">
                <div className="container">
                    <div className="text-center p-3 mb-4" style={{ backgroundColor: 'skyblue' }}>
                        <h1>Contact Us</h1>
                    </div>
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-12 col-md-4" data-aos="flip-right">
                            <iframe
                                ...
                                title="Kreevtech Location"
                            ></iframe>
                        </div>

                        {/* Contact Info & Form */}
                        <div className="col-12 col-md-8" data-aos="flip-left">
                            {/* Info Icons */}
                            <div className="d-flex flex-column flex-md-row justify-content-between mb-3 text-center text-md-start gap-3">
                                <div className="d-flex align-items-center gap-2">
                                    <i className="fa-solid fa-location-dot text-primary fs-4"></i>
                                    <span>20, Collector Sivakumar Street,<br />Saibaba Colony, Coimbatore - 641038</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                    <i className="fa-solid fa-envelope text-primary fs-4"></i>
                                    <span>kreevtechsolutions@gmail.com</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                    <i className="fa-solid fa-phone text-primary fs-4"></i>
                                    <span>7397099745</span>
                                </div>
                            </div>
            ...
            {/* Footer Info */}
            <div className="py-4 bg-primary text-light mt-5">
                <div className="container">
                    <div className="row g-4">
                        <div className="col-12 col-md-4">
                            <h5>KREEVTECH SOLUTION</h5>
                            <p style={{ textAlign: 'justify' }}>
                                KREEVTECH SOLUTION is a Software Development & Training Company.
                                We offer programs for every skill level, empowering developers globally with the
                                knowledge needed to succeed. Our courses provide a solid foundation in development
                                principles, ensuring precise and fast coding skills.
                            </p>
                        </div>
                        <div className="col-12 col-md-4">
                            <h5>Useful Links</h5>
                            <div className="d-flex flex-column gap-2">
                                ...
                                <a href="/Product" className="text-light">Product</a>
                        ...
                        <div className="col-12 col-md-4">
                            <h5>Contact Us</h5>
                            <p>
                                <b>Address:</b> 20, Collector Sivakumar Street, Saibaba Colony, Coimbatore - 641038 <br />
                                <b>Phone:</b> 7397099745 <br />
                                <b>Email:</b> kreevtechsolutions@gmail.com
                            </p>
                            <div className="d-flex gap-3">
                                <a href="#"><i className="fa-brands fa-instagram text-light"></i></a>
                                <a href="#"><i className="fa-brands fa-square-youtube text-light"></i></a>
            ...
            {/* Footer Copyright */}
            <footer className="bg-light text-center py-3 mt-3">
                <i className="fa-regular fa-copyright"></i> www.kreevtechsolutions.com. All Rights Reserved
            </footer>
        </div>
    );
}
